import cv2
import numpy as np 
#couleurs: RGB red green blue, BGR: blue green red, HSV: Hue Saturation and lightness/Brightness
#faut convertir les couleur de BGR à HSV couleurs
...
while True:#get un frame
    ...
    mask = cv2.inRange(hsv, lower_blue, uper_blue)#part of image
    #quel partie d'image qu'on veut le garder
    result = cv2.bitwise_and(frame, frame, mask = mask)# deux source images, les mettre ensemble en utilisant le mask, comparer les pixels, 
    # 1 1 = 1, 1 0 =0, 0 1 = 0, 0 0 =0

    #hsv couleur picker sur internet
